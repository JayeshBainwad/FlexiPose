...
import com.google.mediapipe.examples.poselandmarker.databinding.DialogProgressBinding
...
open class BaseActivity : AppCompatActivity() {
    ...
    fun showProgressDialog(text: String) {
        ...
        // Initialize view binding for dialog
        _dialogBinding = DialogProgressBinding.inflate(layoutInflater)
    ...
    override fun onDestroy() {
        super.onDestroy()
        _dialogBinding = null // Avoid memory leaks
    }
}
// END
